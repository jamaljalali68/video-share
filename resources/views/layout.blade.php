...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Main CSS -->
    <!-- loading css and js assets by Vite -->
        ...
        <div class="container-full">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-12">
                    ...
                    <div id="logo">
                        <a href="01-home.html"><img src="{{ Vite::asset('resources/img/logo.png') }}"></a>
                    </div>
                </div><!-- // col-md-2 -->
                <div class="col-lg-3 col-md-3 col-sm-6 hidden-xs hidden-sm">
                    <div class="search-form">
                        <form id="search" action="#" method="get">
                            <input type="text" name="q" value="{{ request()->query('q') }}" placeholder="جستجو ..." />
                            <input type="hidden" name="sortBy" value="{{ request()->query('sortBy') }}" >
                            <input type="hidden" name="length" value="{{ request()->query('length') }}" >
